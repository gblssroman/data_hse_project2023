...
st.markdown('''Это мы заполняем файл requirements.txt для того, чтобы Streamlit мог автоматом подгрузить нужные нам библиотеки для дальнейшего использования: %pip freeze > requirements.txt''')
